...
export class SystemSettingsService {
  ...
  updateSettings(payload: Partial<Pick<SystemSettings, 'newUserWalletCredit' | 'newClientWalletCredit' | 'newManagerWalletCredit' | 'bookingHoldMinutes'>>): Observable<SystemSettings> {
